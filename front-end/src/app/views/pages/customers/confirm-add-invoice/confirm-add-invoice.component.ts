...
@Component({
	selector: 'kt-confirm-add-invoice',
	templateUrl: './confirm-add-invoice.component.html',
	styleUrls: ['./confirm-add-invoice.component.scss']
})
export class ConfirmAddInvoiceComponent implements OnInit {
	editedItem;
	public _form: FormGroup;

	constructor(
		public snackBar: MatSnackBar,
		public dialogRef: MatDialogRef<ConfirmAddInvoiceComponent>,
	...
	onSubmit() {
			this.invoiceService.addInvoice({customer_id : this.data.customer_id, pure_debt : this.data.pure_debt}).subscribe(res => {
	...
	transformNumberToString(){
		let number = this.data.pure_debt;
